...
void idRenderWindow::PreRender()
{
	if( needsRender )
	{
		...
		if( !modelName[0] )
		{
			idLib::Warning( "Window '%s' in gui '%s': no model set", GetName(), GetGui()->GetSourceFile() );
		}
...
void idRenderWindow::Draw( int time, float x, float y )
{
	...
	refdef.time[0] = time;
	refdef.time[1] = time;
	renderSystem->RenderScene( world, &refdef );
}

/*
====================
idRenderWindow::PostParse
====================
*/
...
/*
====================
idRenderWindow::GetWinVarByName
====================
*/
...
/*
====================
idRenderWindow::ParseInternalVar
====================
*/
