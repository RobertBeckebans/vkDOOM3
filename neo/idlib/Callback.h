...
========================
*/
ID_INLINE idCallbackStatic MakeCallback( void ( *f )( void ) )
{
...
*/
template < class T >
ID_INLINE idCallbackBindMem<T> MakeCallback( T* t, void ( T::*f )( void ) )
{
...
*/
template < class T, typename A1 >
ID_INLINE idCallbackBindMemArg1<T, A1> MakeCallback( T* t, void ( T::*f )( A1 ), A1 a1 )
{
