...
#if defined( CLIP_SPACE_ZERO_TO_ONE )	// the D3D clip space Z is in the range [0,1] so always compare Z vs zero whether 'zeroToOne' is true or false
...
#if !defined( CLIP_SPACE_ZERO_TO_ONE )	// the D3D clip space Z is already in the range [0,1]
...
#if defined( CLIP_SPACE_ZERO_TO_ONE )	// the D3D near plane is at Z=0 instead of Z=-1
