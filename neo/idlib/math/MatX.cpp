...
void idMatX::Test()
{
	...
	*/
	...
	{
		idLib::Warning( "idMatX::LowerTriangularInverse failed" );
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		idLib::Warning( "idMatX::UpperTriangularInverse failed" );
	}
	...
	*/
	...
	{
		idLib::Warning( "idMatX::Inverse_GaussJordan failed" );
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		idLib::Warning( "idMatX::Inverse_UpdateRankOne failed" );
	}
	...
	*/
	...
	for( offset = 0; offset < size; offset++ )
	{
		...
		{
			idLib::Warning( "idMatX::Inverse_UpdateRowColumn failed" );
		}
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		idLib::Warning( "idMatX::Inverse_UpdateIncrement failed" );
	}
	...
	*/
	...
	for( offset = 0; offset < size; offset++ )
	{
		...
		if( !m1.Compare( m2, 1e-3f ) )
		{
			idLib::Warning( "idMatX::Inverse_UpdateDecrement failed" );
		}
	}
	...
	*/
	...
	{
		idLib::Warning( "idMatX::LU_Factor failed" );
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		idLib::Warning( "idMatX::LU_UpdateRankOne failed" );
	}
	...
	*/
	...
	for( offset = 0; offset < size; offset++ )
	{
		...
		if( !m1.Compare( m2, 1e-3f ) )
		{
			idLib::Warning( "idMatX::LU_UpdateRowColumn failed" );
		}
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		idLib::Warning( "idMatX::LU_UpdateIncrement failed" );
	}
	...
	*/
	...
	for( offset = 0; offset < size; offset++ )
	{
		...
		if( !m1.Compare( m2, 1e-3f ) )
		{
			idLib::Warning( "idMatX::LU_UpdateDecrement failed" );
		}
	}
	...
	*/
	...
	if( !m1.IsIdentity( 1e-4f ) )
	{
		idLib::Warning( "idMatX::LU_Inverse failed" );
	}
	...
	*/
	...
	if( !original.Compare( m1, 1e-4f ) )
	{
		idLib::Warning( "idMatX::QR_Factor failed" );
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		idLib::Warning( "idMatX::QR_UpdateRankOne failed" );
	}
	...
	*/
	...
	for( offset = 0; offset < size; offset++ )
	{
		...
		if( !m1.Compare( m2, 1e-3f ) )
		{
			idLib::Warning( "idMatX::QR_UpdateRowColumn failed" );
		}
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		idLib::Warning( "idMatX::QR_UpdateIncrement failed" );
	}
	...
	*/
	...
	for( offset = 0; offset < size; offset++ )
	{
		...
		if( !m1.Compare( m2, 1e-3f ) )
		{
			idLib::Warning( "idMatX::QR_UpdateDecrement failed" );
		}
	}
	...
	*/
	...
	if( !m1.IsIdentity( 1e-4f ) )
	{
		idLib::Warning( "idMatX::QR_Inverse failed" );
	}
	...
	*/
	...
	if( !original.Compare( m1, 1e-4f ) )
	{
		idLib::Warning( "idMatX::SVD_Factor failed" );
	}
	...
	*/
	...
	if( !m1.IsIdentity( 1e-4f ) )
	{
		idLib::Warning( "idMatX::SVD_Inverse failed" );
	}
	...
	*/
	...
	{
		idLib::Warning( "idMatX::Cholesky_Factor failed" );
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		idLib::Warning( "idMatX::Cholesky_UpdateRankOne failed" );
	}
	...
	*/
	...
	for( offset = 0; offset < size; offset++ )
	{
		...
		if( !m1.Compare( m2, 1e-3f ) )
		{
			idLib::Warning( "idMatX::Cholesky_UpdateRowColumn failed" );
		}
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		idLib::Warning( "idMatX::Cholesky_UpdateIncrement failed" );
	}
	...
	*/
	...
	for( offset = 0; offset < size; offset += size - 1 )
	{
		...
		if( !m1.Compare( m2, 1e-3f ) )
		{
			idLib::Warning( "idMatX::Cholesky_UpdateDecrement failed" );
		}
	}
	...
	*/
	...
	if( !m1.IsIdentity( 1e-4f ) )
	{
		idLib::Warning( "idMatX::Cholesky_Inverse failed" );
	}
	...
	*/
	...
	if( !original.Compare( m2, 1e-4f ) )
	{
		idLib::Warning( "idMatX::LDLT_Factor failed" );
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		idLib::Warning( "idMatX::LDLT_UpdateRankOne failed" );
	}
	...
	*/
	...
	for( offset = 0; offset < size; offset++ )
	{
		...
		if( !m1.Compare( m2, 1e-3f ) )
		{
			idLib::Warning( "idMatX::LDLT_UpdateRowColumn failed" );
		}
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		idLib::Warning( "idMatX::LDLT_UpdateIncrement failed" );
	}
	...
	*/
	...
	for( offset = 0; offset < size; offset++ )
	{
		...
		if( !m1.Compare( m2, 1e-3f ) )
		{
			idLib::Warning( "idMatX::LDLT_UpdateDecrement failed" );
		}
	}
	...
	*/
	...
	if( !m1.IsIdentity( 1e-4f ) )
	{
		idLib::Warning( "idMatX::LDLT_Inverse failed" );
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		idLib::Warning( "idMatX::Eigen_SolveSymmetricTriDiagonal failed" );
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		idLib::Warning( "idMatX::Eigen_SolveSymmetric failed" );
	}
	...
	*/
	...
	if( !m1.Compare( m2, 1e-4f ) )
	{
		idLib::Warning( "idMatX::Eigen_Solve failed" );
	}
}
