...
static const __m128i vector_int_neg_one		= _mset_epi32( -1, -1, -1, -1 );
...
{
	const __m128 sX = _msub_ps( vert1X, vert0X );
	const __m128 sY = _msub_ps( vert1Y, vert0Y );
	const __m128 sZ = _msub_ps( vert1Z, vert0Z );
	
	const __m128 tX = _msub_ps( vert2X, vert0X );
	const __m128 tY = _msub_ps( vert2Y, vert0Y );
	const __m128 tZ = _msub_ps( vert2Z, vert0Z );
	
	const __m128 normalX = _mnmsub_ps( tZ, sY, _mmul_ps( tY, sZ ) );
	const __m128 normalY = _mnmsub_ps( tX, sZ, _mmul_ps( tZ, sX ) );
	const __m128 normalZ = _mnmsub_ps( tY, sX, _mmul_ps( tX, sY ) );
	const __m128 normalW = _mmadd_ps( normalX, vert0X, _mmadd_ps( normalY, vert0Y, _mmul_ps( normalZ, vert0Z ) ) );
	
	const __m128 delta = _mnmsub_ps( lightOriginX, normalX, _mnmsub_ps( lightOriginY, normalY, _mnmsub_ps( lightOriginZ, normalZ, normalW ) ) );
	return _mcastps_si128( _mcmplt_ps( delta, _msetzero_ps() ) );
}
		...
		const __m128& lightProjectX, const __m128& lightProjectY, const __m128& lightProjectZ, const __m128& lightProjectW )
{
	...
	const __m128 mvpX0 = _msplat_ps( lightProjectX, 0 );
	const __m128 mvpX1 = _msplat_ps( lightProjectX, 1 );
	const __m128 mvpX2 = _msplat_ps( lightProjectX, 2 );
	const __m128 mvpX3 = _msplat_ps( lightProjectX, 3 );
	
	const __m128 c0X = _mmadd_ps( vert0X, mvpX0, _mmadd_ps( vert0Y, mvpX1, _mmadd_ps( vert0Z, mvpX2, mvpX3 ) ) );
	const __m128 c1X = _mmadd_ps( vert1X, mvpX0, _mmadd_ps( vert1Y, mvpX1, _mmadd_ps( vert1Z, mvpX2, mvpX3 ) ) );
	const __m128 c2X = _mmadd_ps( vert2X, mvpX0, _mmadd_ps( vert2Y, mvpX1, _mmadd_ps( vert2Z, mvpX2, mvpX3 ) ) );
	
	const __m128 mvpY0 = _msplat_ps( lightProjectY, 0 );
	const __m128 mvpY1 = _msplat_ps( lightProjectY, 1 );
	const __m128 mvpY2 = _msplat_ps( lightProjectY, 2 );
	const __m128 mvpY3 = _msplat_ps( lightProjectY, 3 );
	
	const __m128 c0Y = _mmadd_ps( vert0X, mvpY0, _mmadd_ps( vert0Y, mvpY1, _mmadd_ps( vert0Z, mvpY2, mvpY3 ) ) );
	const __m128 c1Y = _mmadd_ps( vert1X, mvpY0, _mmadd_ps( vert1Y, mvpY1, _mmadd_ps( vert1Z, mvpY2, mvpY3 ) ) );
	const __m128 c2Y = _mmadd_ps( vert2X, mvpY0, _mmadd_ps( vert2Y, mvpY1, _mmadd_ps( vert2Z, mvpY2, mvpY3 ) ) );
	
	const __m128 mvpZ0 = _msplat_ps( lightProjectZ, 0 );
	const __m128 mvpZ1 = _msplat_ps( lightProjectZ, 1 );
	const __m128 mvpZ2 = _msplat_ps( lightProjectZ, 2 );
	const __m128 mvpZ3 = _msplat_ps( lightProjectZ, 3 );
	
	const __m128 c0Z = _mmadd_ps( vert0X, mvpZ0, _mmadd_ps( vert0Y, mvpZ1, _mmadd_ps( vert0Z, mvpZ2, mvpZ3 ) ) );
	const __m128 c1Z = _mmadd_ps( vert1X, mvpZ0, _mmadd_ps( vert1Y, mvpZ1, _mmadd_ps( vert1Z, mvpZ2, mvpZ3 ) ) );
	const __m128 c2Z = _mmadd_ps( vert2X, mvpZ0, _mmadd_ps( vert2Y, mvpZ1, _mmadd_ps( vert2Z, mvpZ2, mvpZ3 ) ) );
	
	const __m128 mvpW0 = _msplat_ps( lightProjectW, 0 );
	const __m128 mvpW1 = _msplat_ps( lightProjectW, 1 );
	const __m128 mvpW2 = _msplat_ps( lightProjectW, 2 );
	const __m128 mvpW3 = _msplat_ps( lightProjectW, 3 );
	
	const __m128 c0W = _mmadd_ps( vert0X, mvpW0, _mmadd_ps( vert0Y, mvpW1, _mmadd_ps( vert0Z, mvpW2, mvpW3 ) ) );
	const __m128 c1W = _mmadd_ps( vert1X, mvpW0, _mmadd_ps( vert1Y, mvpW1, _mmadd_ps( vert1Z, mvpW2, mvpW3 ) ) );
	const __m128 c2W = _mmadd_ps( vert2X, mvpW0, _mmadd_ps( vert2Y, mvpW1, _mmadd_ps( vert2Z, mvpW2, mvpW3 ) ) );
	
	const __m128 zero = _msetzero_ps();
	
	__m128 b0 = _mor_ps( _mor_ps( _mcmpgt_ps( c0X, zero ), _mcmpgt_ps( c1X, zero ) ), _mcmpgt_ps( c2X, zero ) );
	__m128 b1 = _mor_ps( _mor_ps( _mcmpgt_ps( c0Y, zero ), _mcmpgt_ps( c1Y, zero ) ), _mcmpgt_ps( c2Y, zero ) );
	__m128 b2 = _mor_ps( _mor_ps( _mcmpgt_ps( c0Z, zero ), _mcmpgt_ps( c1Z, zero ) ), _mcmpgt_ps( c2Z, zero ) );
	__m128 b3 = _mor_ps( _mor_ps( _mcmpgt_ps( c0W, c0X ), _mcmpgt_ps( c1W, c1X ) ), _mcmpgt_ps( c2W, c2X ) );
	__m128 b4 = _mor_ps( _mor_ps( _mcmpgt_ps( c0W, c0Y ), _mcmpgt_ps( c1W, c1Y ) ), _mcmpgt_ps( c2W, c2Y ) );
	__m128 b5 = _mor_ps( _mor_ps( _mcmpgt_ps( c0W, c0Z ), _mcmpgt_ps( c1W, c1Z ) ), _mcmpgt_ps( c2W, c2Z ) );
	...
	return _mcastps_si128( _mcmpeq_ps( b0, zero ) );
}
		...
		bool* insideShadowVolume, const float radius )
{
	...
	const __m128 lightOriginX = _msplat_ps( _mload_ss( &lightOrigin.x ), 0 );
	const __m128 lightOriginY = _msplat_ps( _mload_ss( &lightOrigin.y ), 0 );
	const __m128 lightOriginZ = _msplat_ps( _mload_ss( &lightOrigin.z ), 0 );
	
	const __m128 lightProjectX = _mloadu_ps( lightProject[0] );
	const __m128 lightProjectY = _mloadu_ps( lightProject[1] );
	const __m128 lightProjectZ = _mloadu_ps( lightProject[2] );
	const __m128 lightProjectW = _mloadu_ps( lightProject[3] );
	
	const __m128i cullShadowTrianglesToLightMask = cullShadowTrianglesToLight ? vector_int_neg_one : vector_int_zero;
	
	__m128i numFrontFacing = _msetzero_si128();
	...
	for( int i = 0, j = 0; i < numIndexes; )
	{
		...
		{
			const __m128 vertA0 = _mload_ps( indexedVertsODS[i + 0 * 3 + 0].xyz.ToFloatPtr() );
			const __m128 vertA1 = _mload_ps( indexedVertsODS[i + 0 * 3 + 1].xyz.ToFloatPtr() );
			const __m128 vertA2 = _mload_ps( indexedVertsODS[i + 0 * 3 + 2].xyz.ToFloatPtr() );
			
			const __m128 vertB0 = _mload_ps( indexedVertsODS[i + 1 * 3 + 0].xyz.ToFloatPtr() );
			const __m128 vertB1 = _mload_ps( indexedVertsODS[i + 1 * 3 + 1].xyz.ToFloatPtr() );
			const __m128 vertB2 = _mload_ps( indexedVertsODS[i + 1 * 3 + 2].xyz.ToFloatPtr() );
			
			const __m128 vertC0 = _mload_ps( indexedVertsODS[i + 2 * 3 + 0].xyz.ToFloatPtr() );
			const __m128 vertC1 = _mload_ps( indexedVertsODS[i + 2 * 3 + 1].xyz.ToFloatPtr() );
			const __m128 vertC2 = _mload_ps( indexedVertsODS[i + 2 * 3 + 2].xyz.ToFloatPtr() );
			
			const __m128 vertD0 = _mload_ps( indexedVertsODS[i + 3 * 3 + 0].xyz.ToFloatPtr() );
			const __m128 vertD1 = _mload_ps( indexedVertsODS[i + 3 * 3 + 1].xyz.ToFloatPtr() );
			const __m128 vertD2 = _mload_ps( indexedVertsODS[i + 3 * 3 + 2].xyz.ToFloatPtr() );
			
			const __m128 r0X = _munpacklo_ps( vertA0, vertC0 );	// vertA0.x, vertC0.x, vertA0.z, vertC0.z
			const __m128 r0Y = _munpackhi_ps( vertA0, vertC0 );	// vertA0.y, vertC0.y, vertA0.w, vertC0.w
			const __m128 r0Z = _munpacklo_ps( vertB0, vertD0 );	// vertB0.x, vertD0.x, vertB0.z, vertD0.z
			const __m128 r0W = _munpackhi_ps( vertB0, vertD0 );	// vertB0.y, vertD0.y, vertB0.w, vertD0.w
			
			const __m128 vert0X = _munpacklo_ps( r0X, r0Z );		// vertA0.x, vertB0.x, vertC0.x, vertD0.x
			const __m128 vert0Y = _munpackhi_ps( r0X, r0Z );		// vertA0.y, vertB0.y, vertC0.y, vertD0.y
			const __m128 vert0Z = _munpacklo_ps( r0Y, r0W );		// vertA0.z, vertB0.z, vertC0.z, vertD0.z
			
			const __m128 r1X = _munpacklo_ps( vertA1, vertC1 );	// vertA1.x, vertC1.x, vertA1.z, vertC1.z
			const __m128 r1Y = _munpackhi_ps( vertA1, vertC1 );	// vertA1.y, vertC1.y, vertA1.w, vertC1.w
			const __m128 r1Z = _munpacklo_ps( vertB1, vertD1 );	// vertB1.x, vertD1.x, vertB1.z, vertD1.z
			const __m128 r1W = _munpackhi_ps( vertB1, vertD1 );	// vertB1.y, vertD1.y, vertB1.w, vertD1.w
			
			const __m128 vert1X = _munpacklo_ps( r1X, r1Z );		// vertA1.x, vertB1.x, vertC1.x, vertD1.x
			const __m128 vert1Y = _munpackhi_ps( r1X, r1Z );		// vertA1.y, vertB1.y, vertC1.y, vertD1.y
			const __m128 vert1Z = _munpacklo_ps( r1Y, r1W );		// vertA1.z, vertB1.z, vertC1.z, vertD1.z
			
			const __m128 r2X = _munpacklo_ps( vertA2, vertC2 );	// vertA2.x, vertC2.x, vertA2.z, vertC2.z
			const __m128 r2Y = _munpackhi_ps( vertA2, vertC2 );	// vertA2.y, vertC2.y, vertA2.w, vertC2.w
			const __m128 r2Z = _munpacklo_ps( vertB2, vertD2 );	// vertB2.x, vertD2.x, vertB2.z, vertD2.z
			const __m128 r2W = _munpackhi_ps( vertB2, vertD2 );	// vertB2.y, vertD2.y, vertB2.w, vertD2.w
			
			const __m128 vert2X = _munpacklo_ps( r2X, r2Z );		// vertA2.x, vertB2.x, vertC2.x, vertD2.x
			const __m128 vert2Y = _munpackhi_ps( r2X, r2Z );		// vertA2.y, vertB2.y, vertC2.y, vertD2.y
			const __m128 vert2Z = _munpacklo_ps( r2Y, r2W );		// vertA2.z, vertB2.z, vertC2.z, vertD2.z
			...
			triangleFacing = _mor_si128( triangleFacing, _mand_si128( triangleCulled, cullShadowTrianglesToLightMask ) );
			
			// store culled
			const __m128i culled_s = _mpacks_epi32( triangleCulled, triangleCulled );
			const __m128i culled_b = _mpacks_epi16( culled_s, culled_s );
			*( int* )&culled[j] = _mcvtsi128_si32( culled_b );
			
			// store facing
			const __m128i facing_s = _mpacks_epi32( triangleFacing, triangleFacing );
			const __m128i facing_b = _mpacks_epi16( facing_s, facing_s );
			*( int* )&facing[j] = _mcvtsi128_si32( facing_b );
			
			// count the number of facing triangles
			numFrontFacing = _madd_epi32( numFrontFacing, _mand_si128( triangleFacing, vector_int_one ) );
		}
	...
	numFrontFacing = _madd_epi32( numFrontFacing, _mshuffle_epi32( numFrontFacing, _MM_SHUFFLE( 1, 0, 3, 2 ) ) );
	numFrontFacing = _madd_epi32( numFrontFacing, _mshuffle_epi32( numFrontFacing, _MM_SHUFFLE( 2, 3, 0, 1 ) ) );
	
	return _mcvtsi128_si32( numFrontFacing );
		...
		bool* insideShadowVolume, const float radius )
{
	...
	for( int i = 0; i < numVerts; )
	{
		...
		for( ; i <= nextNumVerts; i++ )
		{
			...
			_mstore_ps( tempVerts[i].ToFloatPtr(), v );
		}
	}
	...
	for( int i = 0, j = 0; i < numIndexes; )
	{
		...
		for( ; i <= batchEnd4x; i += 4 * 3, j += 4 )
		{
			...
			const __m128 vertA0 = _mload_ps( tempVerts[indexA0].ToFloatPtr() );
			const __m128 vertA1 = _mload_ps( tempVerts[indexA1].ToFloatPtr() );
			const __m128 vertA2 = _mload_ps( tempVerts[indexA2].ToFloatPtr() );
			
			const __m128 vertB0 = _mload_ps( tempVerts[indexB0].ToFloatPtr() );
			const __m128 vertB1 = _mload_ps( tempVerts[indexB1].ToFloatPtr() );
			const __m128 vertB2 = _mload_ps( tempVerts[indexB2].ToFloatPtr() );
			
			const __m128 vertC0 = _mload_ps( tempVerts[indexC0].ToFloatPtr() );
			const __m128 vertC1 = _mload_ps( tempVerts[indexC1].ToFloatPtr() );
			const __m128 vertC2 = _mload_ps( tempVerts[indexC2].ToFloatPtr() );
			
			const __m128 vertD0 = _mload_ps( tempVerts[indexD0].ToFloatPtr() );
			const __m128 vertD1 = _mload_ps( tempVerts[indexD1].ToFloatPtr() );
			const __m128 vertD2 = _mload_ps( tempVerts[indexD2].ToFloatPtr() );
...
static void StreamOut( void* dst, const void* src, int numBytes )
{
	...
	{
		__m128i d0 = _mload_si128( ( const __m128i* )( ( byte* )src + i + 0 * 16 ) );
		__m128i d1 = _mload_si128( ( const __m128i* )( ( byte* )src + i + 1 * 16 ) );
		__m128i d2 = _mload_si128( ( const __m128i* )( ( byte* )src + i + 2 * 16 ) );
		__m128i d3 = _mload_si128( ( const __m128i* )( ( byte* )src + i + 3 * 16 ) );
		__m128i d4 = _mload_si128( ( const __m128i* )( ( byte* )src + i + 4 * 16 ) );
		__m128i d5 = _mload_si128( ( const __m128i* )( ( byte* )src + i + 5 * 16 ) );
		__m128i d6 = _mload_si128( ( const __m128i* )( ( byte* )src + i + 6 * 16 ) );
		__m128i d7 = _mload_si128( ( const __m128i* )( ( byte* )src + i + 7 * 16 ) );
		_mstreasi128( ( __m128i* )( ( byte* )dst + i + 0 * 16 ), d0 );
		_mstreasi128( ( __m128i* )( ( byte* )dst + i + 1 * 16 ), d1 );
		_mstreasi128( ( __m128i* )( ( byte* )dst + i + 2 * 16 ), d2 );
		_mstreasi128( ( __m128i* )( ( byte* )dst + i + 3 * 16 ), d3 );
		_mstreasi128( ( __m128i* )( ( byte* )dst + i + 4 * 16 ), d4 );
		_mstreasi128( ( __m128i* )( ( byte* )dst + i + 5 * 16 ), d5 );
		_mstreasi128( ( __m128i* )( ( byte* )dst + i + 6 * 16 ), d6 );
		_mstreasi128( ( __m128i* )( ( byte* )dst + i + 7 * 16 ), d7 );
	}
	for( ; i + 16 <= numBytes; i += 16 )
	{
		__m128i d = _mload_si128( ( __m128i* )( ( byte* )src + i ) );
		_mstreasi128( ( __m128i* )( ( byte* )dst + i ), d );
	}
#else
