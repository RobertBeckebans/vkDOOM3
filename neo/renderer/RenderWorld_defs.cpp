...
/*
=================
idRenderWorld::DeriveEntityData
=================
*/
void idRenderWorld::DeriveEntityData( idRenderEntity* entity )
{
...
/*
===================
idRenderWorld::FreeEntityDefDerivedData

Used by both FreeEntityDef and UpdateEntityDef
Does not actually free the entityDef.
===================
*/
void idRenderWorld::FreeEntityDefDerivedData( idRenderEntity* def, bool keepDecals, bool keepCachedDynamicModel )
{
...
/*
===================
idRenderWorld::FreeEntityDefDecals
===================
*/
void idRenderWorld::FreeEntityDefDecals( idRenderEntity* def )
{
	def->decals = NULL;
}
...
/*
===================
idRenderWorld::FreeEntityDefFadedDecals
===================
*/
void idRenderWorld::FreeEntityDefFadedDecals( idRenderEntity* def, int time )
{
	if( def->decals != NULL )
	{
...
/*
===================
idRenderWorld::FreeEntityDefOverlay
===================
*/
void idRenderWorld::FreeEntityDefOverlay( idRenderEntity* def )
{
	def->overlays = NULL;
}
...
/*
===============
idRenderWorld::CreateEntityRefs
...
===============
*/
void idRenderWorld::CreateEntityRefs( idRenderEntity* entity )
{
...
========================
*/
static float R_ComputePointLightProjectionMatrix( idRenderLight* light, idRenderMatrix& localProject )
{
...
========================
*/
static float R_ComputeSpotLightProjectionMatrix( idRenderLight* light, idRenderMatrix& localProject )
{
...
========================
*/
static float R_ComputeParallelLightProjectionMatrix( idRenderLight* light, idRenderMatrix& localProject )
{
...
=================
*/
static void R_DeriveLightData( idRenderLight* light )
{
...
/*
====================
idRenderWorld::FreeLightDefDerivedData

Frees all references and lit surfaces from the light
====================
*/
void idRenderWorld::FreeLightDefDerivedData( idRenderLight* ldef )
{
...
===============
*/
static bool WindingCompletelyInsideLight( const idWinding* w, const idRenderLight* ldef )
{
...
======================
*/
static void R_CreateLightDefFogPortals( idRenderLight* ldef )
{
...
/*
=================
idRenderWorld::CreateLightRefs
=================
*/
void idRenderWorld::CreateLightRefs( idRenderLight* light )
{
	// derive light data
