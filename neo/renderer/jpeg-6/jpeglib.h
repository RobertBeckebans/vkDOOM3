...
struct jpeg_compress_struct
{
	...
	int nucomponents;		/* # of color components in JPEG image */
	...
	int nuscans;		/* # of entries in scan_info array */
	const jpeg_scan_info* scan_info;  /* script for multi-scan file, or NULL */
	/* The default value of scan_info is NULL, which causes a single-scan
	 * sequential JPEG file to be emitted.  To create a multi-scan file,
	 * set nuscans and scan_info to point to an array of scan definitions.
	 */
...
#define JMSG_STR_PARM_MAX  80
	 ...
	 * should count warnings in nuwarnings.  The surrounding application
	 * can check for bad data by seeing if nuwarnings is nonzero at the
	 * end of processing.
	 */
	long nuwarnings;		/* number of corrupt-data warnings */
...
struct jpeg_destination_mgr
{
	...
	JMETHOD( void, terdestination, ( j_compress_ptr cinfo ) );
};
...
struct jpeg_source_mgr
{
	...
	JMETHOD( void, skip_input_data, ( j_decompress_ptr cinfo, long nubytes ) );
	JMETHOD( boolean, resync_to_restart, ( j_decompress_ptr cinfo, int desired ) );
	JMETHOD( void, tersource, ( j_decompress_ptr cinfo ) );
};
