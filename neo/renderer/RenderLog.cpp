...
const char* renderLogMainBlockLabels[] =
{
	...
	ASSERT_ENUM_STRING( MRB_GPU_SYNC,						9 ),
	ASSERT_ENUM_STRING( MRB_END_FRAME,						10 ),
	ASSERT_ENUM_STRING( MRB_BINK_FRAME,						11 ),
	ASSERT_ENUM_STRING( MRB_BINK_NEXT_FRAME,				12 ),
	ASSERT_ENUM_STRING( MRB_TOTAL,							13 ),
	ASSERT_ENUM_STRING( MRB_MAX,							14 )
};
