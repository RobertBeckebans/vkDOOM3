...
public:
	...
	// Retrieve a list of commands matching the searchString
	virtual void		FindCommands( const char* searchString, idStrList& cmds ) const = 0;
	// Removes a command.
	...
	virtual const char* GetCommandDescription( const char* cmdName ) const = 0;
