...
void idInternalCVar::Set( const char* newValue, bool force, bool fromServer )
{
	...
	if( !force )
	{
		...
		if( flags & CVAR_INIT )
		{
			idLib::Printf( "%s is write protected.\n", nameString.c_str() );
			return;
		}
	}
...
public:
	...
	virtual idCVar* 		FindByIndex( const int index ) const;
...
/*
============
idCVarSystemLocal::Num
============
*/
int idCVarSystemLocal::Num() const
{
	return cvars.Num();
}
...
/*
============
idCVarSystemLocal::FindByIndex
============
*/
idCVar* idCVarSystemLocal::FindByIndex( const int index ) const
{
